...
insert into app_product (id, name, price) values (6, 'BEST CHOICE PRODUCTS 6-AXIS HEADLESS RC QUADCOPTER FPV RC DRONE W/ WIFI HD CAMERA, REAL TIME VIDEO, ALTITUDE HOLD', 42.99);
...
insert into app_product (id, name, price) values (7, 'APXXX MXCBXXK AIR MQD42LL/A 13.3" LCD NOTEBOOK - INTEL CORE I5 (5TH GEN) DUAL-CORE (2 CORE) 1.80 GHZ - 8 GB LPDDR3 - 256 GB SSD - MXC OS SIERRX - 1440 X 900 - INTXL HD GRAPHICS 6000 LPDDR3 - BLUETOOTH - ENGLISH (US) KEYBOARD - FRONT CAMERA/WEBCAM - IEEE 8', 1052.49);
